...
#import "RNBaiduMapViewManager.h"

@implementation RNBaiduMapViewManager

RCT_EXPORT_MODULE(RNBaiduMapView)
RCT_EXPORT_VIEW_PROPERTY(onChange, RCTBubblingEventBlock)
RCT_CUSTOM_VIEW_PROPERTY(center, CLLocationCoordinate2D, RNBaiduMapView) {
...
- (UIView *)view {
    RNBaiduMapView* mapView = [[RNBaiduMapView alloc] init];
